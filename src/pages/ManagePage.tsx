...
export function ManagePage() {
  ...
  const handleDelete = () => {
    ...
    if (confirmDelete.type === 'protocol') deleteProtocol(confirmDelete.id);
  ...
  return (
    <div className="px-5 pt-12 pb-6">
            ...
            <div key={proto.id} className="bg-surface-container-low rounded-2xl p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex gap-1">
                  <button
                    onClick={() => {
                      if (proto.source === 'default') {
                        const copy = duplicateProtocol(proto.id);
                        if (copy) navigate(`/manage/protocols/${copy.id}/edit`);
                      } else {
                        navigate(`/manage/protocols/${proto.id}/edit`);
                      }
                    }}
                    className="p-2 rounded-full hover:bg-surface-variant transition-colors"
                    title={proto.source === 'default' ? 'Duplicate & Edit' : 'Edit'}
                  >
      ...
      {/* Delete confirmation */}
      <BottomSheet open={!!confirmDelete} onClose={() => setConfirmDelete(null)} title="Delete?">
        {confirmDelete && (
          <div className="text-center">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-3 rounded-full bg-error text-on-primary font-medium"
              >
                Delete
              </button>
            </div>
